...
It is worth highlighted that, you could use a deifferent detector (tailored to the application needs), because the proposed methodology is agnostic as far the detector's choise is concerned.
